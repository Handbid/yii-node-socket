        var url = '<?php echo $nodeSocket->clientUrl;?>';
        var params = <?php echo $nodeSocket->clientParams;?>;
...
//		var systemEventsHandlerBinder = new SystemEventsHandlerBinder(this);
	...
	function YiiNodeSocket() {
		...
		// Clear cached rooms/channels so a fresh YiiNodeSocket starts clean
		rooms = {};
		channels = {};
		aliases = {};
		...
		socket = io.connect(url, Object.assign({}, params, {reconnection: false, forceNew: true}));
